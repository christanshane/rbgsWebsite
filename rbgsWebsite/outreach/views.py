...
<html lang="en">
  ...
  <head>
   ...
   <title>Outreach - Recoletos de Bacolod Graduate School - UNO-RECOLETOS</title>
    ...
    <link href="layout1/css/3-col-portfolio.css" rel="stylesheet">
...
<br> <br>
      <!-- Page Heading -->
      <h1 class="my-4">Outreach Programs
        <small>Latest Activities</small>
      </h1>
